package com.prueba.demo.rest.controllers;

import  com.prueba.demo.dto.mapper.ITlp00002Mapper;
    ...
    public void saveTlp00002(@RequestBody Tlp00002DTO tlp00002DTO) throws Exception {
    	...
    	try {
				...
				Tlp00002Id id = new Tlp00002Id();
									...
									id.setCotizacionObligatoria(cotizacionObligatoria);
									id.setCotizacionObligatoriaArp(cotizacionObligatoriaArp);
									id.setCodigoCentroTrabajo(codigoCentroTrabajo);
									id.setCotizacionObligatoriaAfp(cotizacionObligatoriaAfp);
									...
									id.setCotizacionObligatoriaCaja(cotizacionObligatoriaCaja);
									id.setPorcSena(porcSena);
									id.setCotizacionObligatoriaSena(cotizacionObligatoriaSena);
									id.setPorcIcbf(porcIcbf);
									id.setCotizacionObligatoriaIcbf(cotizacionObligatoriaIcbf);
