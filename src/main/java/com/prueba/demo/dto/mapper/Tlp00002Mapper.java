...
import 	com.prueba.demo.modelo.control.*;
	...
	public Tlp00002DTO tlp00002ToTlp00002DTO(Tlp00002 tlp00002)throws Exception{
		try{
			...
			Tlp00002DTO tlp00002DTO = new Tlp00002DTO();
                            ...
                            tlp00002DTO.setCotizacionObligatoria(tlp00002.getId().getCotizacionObligatoria());
                            tlp00002DTO.setCotizacionObligatoriaArp(tlp00002.getId().getCotizacionObligatoriaArp());
                            tlp00002DTO.setCodigoCentroTrabajo(tlp00002.getId().getCodigoCentroTrabajo());
                            tlp00002DTO.setCotizacionObligatoriaAfp(tlp00002.getId().getCotizacionObligatoriaAfp());
                            ...
                            tlp00002DTO.setCotizacionObligatoriaCaja(tlp00002.getId().getCotizacionObligatoriaCaja());
                            tlp00002DTO.setPorcSena(tlp00002.getId().getPorcSena());
                            tlp00002DTO.setCotizacionObligatoriaSena(tlp00002.getId().getCotizacionObligatoriaSena());
                            tlp00002DTO.setPorcIcbf(tlp00002.getId().getPorcIcbf());
                            tlp00002DTO.setCotizacionObligatoriaIcbf(tlp00002.getId().getCotizacionObligatoriaIcbf());
...
tlp00002Id.setIngresoBaseCotizacionSenaIcbf(tlp00002DTO.getIngresoBaseCotizacionSenaIcbf() != null ? tlp00002DTO.getIngresoBaseCotizacionSenaIcbf() : null);
                            			if(tlp00002DTO.getCotizacionObligatoria() != null && tlp00002DTO.getCotizacionObligatoria().toString().length() <= 0 ) {
				throw new Exception("La llave no puede ser nula");
			}

tlp00002Id.setCotizacionObligatoria(tlp00002DTO.getCotizacionObligatoria() != null ? tlp00002DTO.getCotizacionObligatoria() : null);
                            			if(tlp00002DTO.getCotizacionObligatoriaArp() != null && tlp00002DTO.getCotizacionObligatoriaArp().toString().length() <= 0 ) {
				throw new Exception("La llave no puede ser nula");
			}

tlp00002Id.setCotizacionObligatoriaArp(tlp00002DTO.getCotizacionObligatoriaArp() != null ? tlp00002DTO.getCotizacionObligatoriaArp() : null);
...
tlp00002Id.setCodigoCentroTrabajo(tlp00002DTO.getCodigoCentroTrabajo() != null ? tlp00002DTO.getCodigoCentroTrabajo() : null);
                            			if(tlp00002DTO.getCotizacionObligatoriaAfp() != null && tlp00002DTO.getCotizacionObligatoriaAfp().toString().length() <= 0 ) {
				throw new Exception("La llave no puede ser nula");
			}

tlp00002Id.setCotizacionObligatoriaAfp(tlp00002DTO.getCotizacionObligatoriaAfp() != null ? tlp00002DTO.getCotizacionObligatoriaAfp() : null);
...
tlp00002Id.setPorcCaja(tlp00002DTO.getPorcCaja() != null ? tlp00002DTO.getPorcCaja() : null);
                            			if(tlp00002DTO.getCotizacionObligatoriaCaja() != null && tlp00002DTO.getCotizacionObligatoriaCaja().toString().length() <= 0 ) {
				throw new Exception("La llave no puede ser nula");
			}

tlp00002Id.setCotizacionObligatoriaCaja(tlp00002DTO.getCotizacionObligatoriaCaja() != null ? tlp00002DTO.getCotizacionObligatoriaCaja() : null);
...
tlp00002Id.setPorcSena(tlp00002DTO.getPorcSena() != null ? tlp00002DTO.getPorcSena() : null);
                            			if(tlp00002DTO.getCotizacionObligatoriaSena() != null && tlp00002DTO.getCotizacionObligatoriaSena().toString().length() <= 0 ) {
				throw new Exception("La llave no puede ser nula");
			}

tlp00002Id.setCotizacionObligatoriaSena(tlp00002DTO.getCotizacionObligatoriaSena() != null ? tlp00002DTO.getCotizacionObligatoriaSena() : null);
...
tlp00002Id.setPorcIcbf(tlp00002DTO.getPorcIcbf() != null ? tlp00002DTO.getPorcIcbf() : null);
                            			if(tlp00002DTO.getCotizacionObligatoriaIcbf() != null && tlp00002DTO.getCotizacionObligatoriaIcbf().toString().length() <= 0 ) {
				throw new Exception("La llave no puede ser nula");
			}

tlp00002Id.setCotizacionObligatoriaIcbf(tlp00002DTO.getCotizacionObligatoriaIcbf() != null ? tlp00002DTO.getCotizacionObligatoriaIcbf() : null);
