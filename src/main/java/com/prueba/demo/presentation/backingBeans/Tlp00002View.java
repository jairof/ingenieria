...
import com.prueba.demo.modelo.dto.Tlp00002DTO;
...
super();
    ...
    private InputText txtCotizacionObligatoria;
    private InputText txtCotizacionObligatoriaArp;
    private InputText txtCodigoCentroTrabajo;
    private InputText txtCotizacionObligatoriaAfp;
    ...
    private InputText txtCotizacionObligatoriaCaja;
    private InputText txtPorcSena;
    private InputText txtCotizacionObligatoriaSena;
    private InputText txtPorcIcbf;
    private InputText txtCotizacionObligatoriaIcbf;
...
private IBusinessDelegatorView businessDelegatorView;
		...
		selectedTlp00002 = null;
             ...
             txtCodEps_Tp000003.setDisabled(true);
				   ...
				   txtIngresoBaseCotizacionSenaIcbf.setDisabled(false);	
        			    ...
        			    if(txtCotizacionObligatoria != null){
				   txtCotizacionObligatoria.setValue(null);
				   txtCotizacionObligatoria.setDisabled(false);	
				}
        			    if(txtCotizacionObligatoriaArp != null){
				   txtCotizacionObligatoriaArp.setValue(null);
				   txtCotizacionObligatoriaArp.setDisabled(false);	
				}
        			    if(txtCodigoCentroTrabajo != null){
				   txtCodigoCentroTrabajo.setValue(null);
				   txtCodigoCentroTrabajo.setDisabled(false);	
				}
        			    if(txtCotizacionObligatoriaAfp != null){
				   txtCotizacionObligatoriaAfp.setValue(null);
				   txtCotizacionObligatoriaAfp.setDisabled(false);	
				}
				   ...
				   txtPorcCaja.setDisabled(false);	
        			    ...
        			    if(txtCotizacionObligatoriaCaja != null){
				   txtCotizacionObligatoriaCaja.setValue(null);
				   txtCotizacionObligatoriaCaja.setDisabled(false);	
				}
        			    if(txtPorcSena != null){
				   txtPorcSena.setValue(null);
				   txtPorcSena.setDisabled(false);	
				}
        			    if(txtCotizacionObligatoriaSena != null){
				   txtCotizacionObligatoriaSena.setValue(null);
				   txtCotizacionObligatoriaSena.setDisabled(false);	
				}
        			    if(txtPorcIcbf != null){
				   txtPorcIcbf.setValue(null);
				   txtPorcIcbf.setDisabled(false);	
				}
        			    if(txtCotizacionObligatoriaIcbf != null){
				   txtCotizacionObligatoriaIcbf.setValue(null);
				   txtCotizacionObligatoriaIcbf.setDisabled(false);	
				}
	...
	public void listener_txtId(){
	    ...
	    try {
	    	        ...
	    	        id.setCotizacionObligatoria((txtCotizacionObligatoria.getValue())==null||(txtCotizacionObligatoria.getValue()).equals("")?null: FacesUtils.checkDouble(txtCotizacionObligatoria));
	    	        id.setCotizacionObligatoriaArp((txtCotizacionObligatoriaArp.getValue())==null||(txtCotizacionObligatoriaArp.getValue()).equals("")?null: FacesUtils.checkDouble(txtCotizacionObligatoriaArp));
	    	        ...
	    	        id.setCotizacionObligatoriaAfp((txtCotizacionObligatoriaAfp.getValue())==null||(txtCotizacionObligatoriaAfp.getValue()).equals("")?null: FacesUtils.checkDouble(txtCotizacionObligatoriaAfp));
	    	        ...
	    	        id.setCotizacionObligatoriaCaja((txtCotizacionObligatoriaCaja.getValue())==null||(txtCotizacionObligatoriaCaja.getValue()).equals("")?null: FacesUtils.checkDouble(txtCotizacionObligatoriaCaja));
	    	        id.setPorcSena((txtPorcSena.getValue())==null||(txtPorcSena.getValue()).equals("")?null: FacesUtils.checkDouble(txtPorcSena));
	    	        id.setCotizacionObligatoriaSena((txtCotizacionObligatoriaSena.getValue())==null||(txtCotizacionObligatoriaSena.getValue()).equals("")?null: FacesUtils.checkDouble(txtCotizacionObligatoriaSena));
	    	        id.setPorcIcbf((txtPorcIcbf.getValue())==null||(txtPorcIcbf.getValue()).equals("")?null: FacesUtils.checkDouble(txtPorcIcbf));
	    	        id.setCotizacionObligatoriaIcbf((txtCotizacionObligatoriaIcbf.getValue())==null||(txtCotizacionObligatoriaIcbf.getValue()).equals("")?null: FacesUtils.checkDouble(txtCotizacionObligatoriaIcbf));
		...
		if(entity==null){
	    	        ...
	    	        txtCodUsuario.setDisabled(false);
		    		        ...
		    		        txtCotizacionObligatoria.setValue(entity.getId().getCotizacionObligatoria());txtCotizacionObligatoria.setDisabled(true);
		    		        txtCotizacionObligatoriaArp.setValue(entity.getId().getCotizacionObligatoriaArp());txtCotizacionObligatoriaArp.setDisabled(true);
		    		        txtCodigoCentroTrabajo.setValue(entity.getId().getCodigoCentroTrabajo());txtCodigoCentroTrabajo.setDisabled(true);
		    		        txtCotizacionObligatoriaAfp.setValue(entity.getId().getCotizacionObligatoriaAfp());txtCotizacionObligatoriaAfp.setDisabled(true);
		    		        ...
		    		        txtCotizacionObligatoriaCaja.setValue(entity.getId().getCotizacionObligatoriaCaja());txtCotizacionObligatoriaCaja.setDisabled(true);
		    		        txtPorcSena.setValue(entity.getId().getPorcSena());txtPorcSena.setDisabled(true);
		    		        txtCotizacionObligatoriaSena.setValue(entity.getId().getCotizacionObligatoriaSena());txtCotizacionObligatoriaSena.setDisabled(true);
		    		        txtPorcIcbf.setValue(entity.getId().getPorcIcbf());txtPorcIcbf.setDisabled(true);
		    		        txtCotizacionObligatoriaIcbf.setValue(entity.getId().getCotizacionObligatoriaIcbf());txtCotizacionObligatoriaIcbf.setDisabled(true);
	...
	public String action_edit(ActionEvent evt){
    	...
    	selectedTlp00002 = (Tlp00002DTO)(evt.getComponent().getAttributes().get("selectedTlp00002"));		
            ...
            txtCotizacionObligatoria.setValue(selectedTlp00002.getCotizacionObligatoria());txtCotizacionObligatoria.setDisabled(true);
            txtCotizacionObligatoriaArp.setValue(selectedTlp00002.getCotizacionObligatoriaArp());txtCotizacionObligatoriaArp.setDisabled(true);
            txtCodigoCentroTrabajo.setValue(selectedTlp00002.getCodigoCentroTrabajo());txtCodigoCentroTrabajo.setDisabled(true);
            txtCotizacionObligatoriaAfp.setValue(selectedTlp00002.getCotizacionObligatoriaAfp());txtCotizacionObligatoriaAfp.setDisabled(true);
            ...
            txtCotizacionObligatoriaCaja.setValue(selectedTlp00002.getCotizacionObligatoriaCaja());txtCotizacionObligatoriaCaja.setDisabled(true);
            txtPorcSena.setValue(selectedTlp00002.getPorcSena());txtPorcSena.setDisabled(true);
            txtCotizacionObligatoriaSena.setValue(selectedTlp00002.getCotizacionObligatoriaSena());txtCotizacionObligatoriaSena.setDisabled(true);
            txtPorcIcbf.setValue(selectedTlp00002.getPorcIcbf());txtPorcIcbf.setDisabled(true);
            txtCotizacionObligatoriaIcbf.setValue(selectedTlp00002.getCotizacionObligatoriaIcbf());txtCotizacionObligatoriaIcbf.setDisabled(true);
	...
	public String action_modify() {
        try {
        	if(entity==null){
		    		        ...
		    		        id.setCotizacionObligatoria(selectedTlp00002.getCotizacionObligatoria());
		    		        id.setCotizacionObligatoriaArp(selectedTlp00002.getCotizacionObligatoriaArp());
		    		        id.setCodigoCentroTrabajo(selectedTlp00002.getCodigoCentroTrabajo());
		    		        id.setCotizacionObligatoriaAfp(selectedTlp00002.getCotizacionObligatoriaAfp());
		    		        ...
		    		        id.setCotizacionObligatoriaCaja(selectedTlp00002.getCotizacionObligatoriaCaja());
		    		        id.setPorcSena(selectedTlp00002.getPorcSena());
		    		        id.setCotizacionObligatoriaSena(selectedTlp00002.getCotizacionObligatoriaSena());
		    		        id.setPorcIcbf(selectedTlp00002.getPorcIcbf());
		    		        id.setCotizacionObligatoriaIcbf(selectedTlp00002.getCotizacionObligatoriaIcbf());
    ...
    public String action_closeDialog(){
        ...
        public String action_modifyWitDTO(String numPlanilla, String codiEps, String codiArp, String codiAfp, String codiCaja, String cotizante, String codEmpresaEmp, String ciuLaboralCotizante, String depLaboralCotizante, String tipocotizante, String subTipocotizante, Integer diasCotizados, Integer diasCotizadosArp, Integer diasCotizadosAfp, Integer diasCotizadosCaja, Double salarioBasico, String salarioCIntegral, String planillaEps, String planillaArp, String planillaAfp, String planillaCaja, String numAuincapacidad, Double valorIncapacidad, String numAulicenciaM, Double valorLicenciaM, Double valorUpcAdicional, Double ingresoBaseCotizacion, Double ingresoBaseCotizacionArp, Double ingresoBaseCotizacionAfp, Double ingresoBaseCotizacionCaja, Double ingresoBaseCotizacionSenaIcbf, Double cotizacio, Double cotizacion, String codigoCentroTrabajo, Double cotizaci, Double valorFpsolidaridad, Double valorFpsubsistencia, Integer riesgos, Double porcEps, Double porcRiesgo, Double porcAfp, Double porcCaja, Double cotizacionObligatoria, Double porcSena, Double cotizacionObligatoriaArp, Double porcIcbf, Double cotizacionObligatoriaAfp, String detaPlanPrimeraEps, String detaPlanPrimeraArp, String detaPlanPrimeraAfp, String detaPlanPrimeraCaja, String ing, String ret, String tde, String tae, String codiEpsTraslado, String tdp, String tap, String codiAfpTraslado, String tda, String taa, String vsp, String vte, String vst, String sln, String ige, String lma, String vac, String avp, String vct, String irp, String codUsuario, String codEps_Tp000003) throws Exception {
        try {
        ...
        return "";
                                                ...
                                                this.txtIngresoBaseCotizacionSenaIcbf = txtIngresoBaseCotizacionSenaIcbf;
                                                                                            ...
                                                                                            public InputText getTxtCotizacionObligatoria() {
                                                return txtCotizacionObligatoria;
                                                }
                                                public void setTxtCotizacionObligatoria(InputText txtCotizacionObligatoria) {
                                                this.txtCotizacionObligatoria = txtCotizacionObligatoria;
                                                }
                                                                                            public InputText getTxtCotizacionObligatoriaArp() {
                                                return txtCotizacionObligatoriaArp;
                                                }
                                                public void setTxtCotizacionObligatoriaArp(InputText txtCotizacionObligatoriaArp) {
                                                this.txtCotizacionObligatoriaArp = txtCotizacionObligatoriaArp;
                                                }
                                                ...
                                                this.txtCodigoCentroTrabajo = txtCodigoCentroTrabajo;
                                                                                            ...
                                                                                            public InputText getTxtCotizacionObligatoriaAfp() {
                                                return txtCotizacionObligatoriaAfp;
                                                }
                                                public void setTxtCotizacionObligatoriaAfp(InputText txtCotizacionObligatoriaAfp) {
                                                this.txtCotizacionObligatoriaAfp = txtCotizacionObligatoriaAfp;
                                                }
                                                ...
                                                this.txtPorcCaja = txtPorcCaja;
                                                                                            ...
                                                                                            public InputText getTxtCotizacionObligatoriaCaja() {
                                                return txtCotizacionObligatoriaCaja;
                                                }
                                                public void setTxtCotizacionObligatoriaCaja(InputText txtCotizacionObligatoriaCaja) {
                                                this.txtCotizacionObligatoriaCaja = txtCotizacionObligatoriaCaja;
                                                }
                                                ...
                                                this.txtPorcSena = txtPorcSena;
                                                                                            ...
                                                                                            public InputText getTxtCotizacionObligatoriaSena() {
                                                return txtCotizacionObligatoriaSena;
                                                }
                                                public void setTxtCotizacionObligatoriaSena(InputText txtCotizacionObligatoriaSena) {
                                                this.txtCotizacionObligatoriaSena = txtCotizacionObligatoriaSena;
                                                }
                                                ...
                                                this.txtPorcIcbf = txtPorcIcbf;
                                                                                            ...
                                                                                            public InputText getTxtCotizacionObligatoriaIcbf() {
                                                return txtCotizacionObligatoriaIcbf;
                                                }
                                                public void setTxtCotizacionObligatoriaIcbf(InputText txtCotizacionObligatoriaIcbf) {
                                                this.txtCotizacionObligatoriaIcbf = txtCotizacionObligatoriaIcbf;
                                                }
