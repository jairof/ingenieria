...
/**
* oauthor Zathura Code Generator http://zathuracode.org/
* www.zathuracode.org
* 
*/
@Entity
public class Tlp00002Id implements java.io.Serializable {
		...
		private Double cotizacionObligatoria;	
    		@Id
    		@NotNull
		private Double cotizacionObligatoriaArp;	
    		@Id
    		@NotNull
		private String codigoCentroTrabajo;	
    		@Id
    		@NotNull
		private Double cotizacionObligatoriaAfp;	
    		@Id
    		@NotNull
		...
		private Double porcCaja;	
    		@Id
    		@NotNull
		private Double cotizacionObligatoriaCaja;	
    		@Id
    		@NotNull
		private Double porcSena;	
    		@Id
    		@NotNull
		private Double cotizacionObligatoriaSena;	
    		@Id
    		@NotNull
		private Double porcIcbf;	
    		@Id
    		@NotNull
		private Double cotizacionObligatoriaIcbf;	
    		@Id
    		@NotNull
     ...
     public Tlp00002Id() {
		...
		public Double getCotizacionObligatoria() {
	        return this.cotizacionObligatoria;
	    }
	    
	    public void setCotizacionObligatoria(Double cotizacionObligatoria) {
	        this.cotizacionObligatoria = cotizacionObligatoria;
	    }
    
    		
		public Double getCotizacionObligatoriaArp() {
	        return this.cotizacionObligatoriaArp;
	    }
	    
	    public void setCotizacionObligatoriaArp(Double cotizacionObligatoriaArp) {
	        this.cotizacionObligatoriaArp = cotizacionObligatoriaArp;
	    }
		...
		public Double getCotizacionObligatoriaAfp() {
	        return this.cotizacionObligatoriaAfp;
	    }
	    
	    public void setCotizacionObligatoriaAfp(Double cotizacionObligatoriaAfp) {
		...
		public Double getCotizacionObligatoriaCaja() {
	        return this.cotizacionObligatoriaCaja;
	    }
	    
	    public void setCotizacionObligatoriaCaja(Double cotizacionObligatoriaCaja) {
	        this.cotizacionObligatoriaCaja = cotizacionObligatoriaCaja;
	    }
		...
		public Double getCotizacionObligatoriaSena() {
	        return this.cotizacionObligatoriaSena;
	    }
	    
	    public void setCotizacionObligatoriaSena(Double cotizacionObligatoriaSena) {
	        this.cotizacionObligatoriaSena = cotizacionObligatoriaSena;
	    }
		...
		public Double getCotizacionObligatoriaIcbf() {
	        return this.cotizacionObligatoriaIcbf;
	    }
	    
	    public void setCotizacionObligatoriaIcbf(Double cotizacionObligatoriaIcbf) {
	        this.cotizacionObligatoriaIcbf = cotizacionObligatoriaIcbf;
	    }
    ...
    public int hashCode() {
         int result = 17;
	     			 ...
	     			 result = 37 * result + ( getCotizacionObligatoria() == null ? 0 : this.getCotizacionObligatoria().hashCode() );	
	     			 result = 37 * result + ( getCotizacionObligatoriaArp() == null ? 0 : this.getCotizacionObligatoriaArp().hashCode() );	
	     			 result = 37 * result + ( getCodigoCentroTrabajo() == null ? 0 : this.getCodigoCentroTrabajo().hashCode() );	
	     			 result = 37 * result + ( getCotizacionObligatoriaAfp() == null ? 0 : this.getCotizacionObligatoriaAfp().hashCode() );	
	     			 ...
	     			 result = 37 * result + ( getCotizacionObligatoriaCaja() == null ? 0 : this.getCotizacionObligatoriaCaja().hashCode() );	
	     			 result = 37 * result + ( getPorcSena() == null ? 0 : this.getPorcSena().hashCode() );	
	     			 result = 37 * result + ( getCotizacionObligatoriaSena() == null ? 0 : this.getCotizacionObligatoriaSena().hashCode() );	
	     			 result = 37 * result + ( getPorcIcbf() == null ? 0 : this.getPorcIcbf().hashCode() );	
	     			 result = 37 * result + ( getCotizacionObligatoriaIcbf() == null ? 0 : this.getCotizacionObligatoriaIcbf().hashCode() );	
