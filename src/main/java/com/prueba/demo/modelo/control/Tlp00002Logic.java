             ...
             log.debug("deleting Tlp00002 instance");
	            ...
	            if(entity==null){
	    			throw new ZMessManager().new NullEntityExcepcion("Tlp00002");
                                    ...
                                    if(entity.getId().getCotizacionObligatoria()==null){throw new ZMessManager().new EmptyFieldException("cotizaci�nObligatoria");}
                                    if(entity.getId().getCotizacionObligatoriaArp()==null){throw new ZMessManager().new EmptyFieldException("cotizaci�nObligatoriaArp");}
                                    if(entity.getId().getCodigoCentroTrabajo()==null){throw new ZMessManager().new EmptyFieldException("codigoCentroTrabajo");}
                                    if(entity.getId().getCotizacionObligatoriaAfp()==null){throw new ZMessManager().new EmptyFieldException("cotizaci�nObligatoriaAfp");}
                                    ...
                                    if(entity.getId().getCotizacionObligatoriaCaja()==null){throw new ZMessManager().new EmptyFieldException("cotizaci�nObligatoriaCaja");}
                                    if(entity.getId().getPorcSena()==null){throw new ZMessManager().new EmptyFieldException("porcSena");}
                                    if(entity.getId().getCotizacionObligatoriaSena()==null){throw new ZMessManager().new EmptyFieldException("cotizaci�nObligatoriaSena");}
                                    if(entity.getId().getPorcIcbf()==null){throw new ZMessManager().new EmptyFieldException("porcIcbf");}
                                    if(entity.getId().getCotizacionObligatoriaIcbf()==null){throw new ZMessManager().new EmptyFieldException("cotizaci�nObligatoriaIcbf");}
